...
describe('parse', function () {
  ...
  describe('variables', function () {
    it('should parse valid variable assignments', function () {
      ...
      assert.strictEqual(parseAndEval('b c = 0.75', scope), 0.75)
      assert.strictEqual(parseAndEval('b c + 2', scope), 2.75)
      assert.strictEqual(parseAndEval('b c = 2', scope), 2)
      assert.strictEqual(parseAndEval('b c + 2', scope), 4)
      assert.strictEqual(parseAndEval('d e f = 0.75', scope), 0.75)
      assert.strictEqual(parseAndEval('d e f + 2', scope), 2.75)
      assert.strictEqual(parseAndEval('d e f = 2', scope), 2)
      assert.strictEqual(parseAndEval('d e f + 2', scope), 4)
      assert.strictEqual(parseAndEval('g h 1 = 0.75', scope), 0.75)
      assert.strictEqual(parseAndEval('g h 1 + 2', scope), 2.75)
      assert.strictEqual(parseAndEval('g h 1 = 2', scope), 2)
      assert.strictEqual(parseAndEval('g h 1 + 2', scope), 4)
  ...
  describe('operators', function () {
    ...
    it('should tell the OperatorNode about implicit multiplications', function () {
      ...
      assert.strictEqual(parse('a b').implicit, undefined)
      assert.strictEqual(parse('2a b').implicit, true)
      assert.strictEqual(parse('a b c').implicit, undefined)
